      ...
      /> */}
        ...
        <section className="sectionWrapper" id="resourcesPage">
          <div className="container">
              ...
              <div className="row justify-content-center row-cols-1 row-cols-md-7 g-3" id="catResources">
                {/* <div className="col">
            ...
            <div className="col-md-4">
                <div className="resourceCard">
                  ...
                  <Link href='#' className="link-primary">Download</Link>
                </div>
            </div>
            ...
            <div className="col-md-4">
                <div className="resourceCard">
                  ...
                  <Link href='#' className="link-primary">View</Link>
                </div>
            </div>
