    ...
    <section id="homeBanner">
          <div className="video-container">
            ...
            <video autoPlay loop muted playsInline preload="none" className="background-video" poster="/images/video-poster.jpg">
              {/* <source src="/videos/pratyaksh-home-video.webm" type="video/webm" /> */}
                       ...
                       <Link href={`/resources/${item.Slug || item.slug || ''}`}>
                        <div className="resource-home">
                          ...
                          <div className="resource-homeDetail">
                            <span className="badge resourceTag">{(item.ResourceType && (item.ResourceType.Name || item.ResourceType.name)) || 'Resource'}</span>
...
export async function getServerSideProps() {
  ...
  try {
    const res = await fetch(`${base}/api/homepage-setting?populate[homepage_news][populate]=*&populate[homepage_resources][populate]=*`);
    if (!res.ok) {
